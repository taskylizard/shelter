...
impl From<Config> for core::Config {
    fn from(options: Config) -> Self {
        ...
        Self {
            ...
            generate: options.generate.map(|v| v.into()).unwrap_or(default.generate),
            ...
            require_import_source: options.require_import_source.unwrap_or(default.require_import_source),
            wrap_conditionals: options.wrap_conditionals.unwrap_or(default.wrap_conditionals),
            omit_nested_closing_tags: options.omit_nested_closing_tags.unwrap_or(default.omit_nested_closing_tags),
            context_to_custom_elements: options.context_to_custom_elements.unwrap_or(default.context_to_custom_elements),
